...
### Changes & Improvements:
 ...
 - The screenshot and the live view can be zoomed between 100% and 1000% with Ctrl+Wheel (Cmd+Wheel on macOS), and the zoomed image moved with a Ctrl+middle mouse button drag or with the scrollbars that appear.
